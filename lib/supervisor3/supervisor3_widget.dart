...
class Supervisor3Widget extends StatefulWidget {
  const Supervisor3Widget({Key key}) : super(key: key);

  @override
  _Supervisor3WidgetState createState() => _Supervisor3WidgetState();
}

class _Supervisor3WidgetState extends State<Supervisor3Widget> {
