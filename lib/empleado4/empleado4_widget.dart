...
class Empleado4Widget extends StatefulWidget {
  const Empleado4Widget({Key key}) : super(key: key);

  @override
  _Empleado4WidgetState createState() => _Empleado4WidgetState();
}

class _Empleado4WidgetState extends State<Empleado4Widget> {
