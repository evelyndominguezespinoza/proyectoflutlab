...
class Empleado6Widget extends StatefulWidget {
  const Empleado6Widget({Key key}) : super(key: key);

  @override
  _Empleado6WidgetState createState() => _Empleado6WidgetState();
}

class _Empleado6WidgetState extends State<Empleado6Widget> {
