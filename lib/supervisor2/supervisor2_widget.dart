...
class Supervisor2Widget extends StatefulWidget {
  const Supervisor2Widget({Key key}) : super(key: key);

  @override
  _Supervisor2WidgetState createState() => _Supervisor2WidgetState();
}

class _Supervisor2WidgetState extends State<Supervisor2Widget> {
